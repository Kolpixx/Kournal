            ...
            <div className="creation-input-container">
                <div className="creation-top">
                    ...
                    <div className="creation-actions">
                        <button className="exit-button" onClick={() => setShowing(false)}>
                            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M33 3L3 33M3 3L33 33" stroke="black" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                        <button className="send-button" onClick={() => saveDiary(currentEmoji, setShowing)}>
