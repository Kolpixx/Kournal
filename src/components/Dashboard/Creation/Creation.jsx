...
export default function Creation({showCreationPage, currentEntryKey, editingMode, toggleEditingMode}) {
    ...
    return (
        <div className="creation">
            {showingAttachmentWindow && <AttachmentWindow toggleAttachmentWindow={toggleAttachmentWindow} />}
                ...
                <div className="creation-top">
                    <div className="emoji">
                        <button className="emoji-button" onClick={() => toggleEmojiPicker(!showingEmojiPicker)}>
                            {currentEmoji === null ? <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none" stroke="var(--primary-color-trans)" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-smile-icon lucide-smile"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" x2="9.01" y1="9" y2="9"/><line x1="15" x2="15.01" y1="9" y2="9"/></svg> : <span className="emoji-display">{currentEmoji}</span>}
                        </button>
